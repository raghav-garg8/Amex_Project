-- database/schema.sql
-- Database DDL schema for LifeEventRadar.
...
CREATE TABLE merchants (
    ...
    is_amex_partner TINYINT(1) NOT NULL DEFAULT 0,
...
CREATE TABLE customer_features (
    ...
    spend_growth_3m DECIMAL(5,4) NOT NULL DEFAULT 0.0000,
